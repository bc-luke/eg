 ...
 */
public abstract class AbstractEgParser
...

{
     ...
     */
    protected AbstractEgParser(TokenStream input) {
        super(input);
    }
     ...
     */
    protected AbstractEgParser(TokenStream input, RecognizerSharedState state) {
        super(input, state);
    }
